...
// Modified:
// - Widen SADDR to 2 bits
// - Provide three parameter sets (e.g., S1-, S2-, S3-*)
// - Double the ROM depth from 64 to 128 words
// - Add the ability to switch among three clock sources
...
module mmcme2_drp #(
  ...
  reg     [38:0] rom           [127:0];  // 39 bit word 127 words deep
  reg     [ 6:0] rom_addr;
  reg     [38:0] rom_do;
  ...
  localparam [37:0] S1_CLKFBOUT_FRAC_CALC = mmcm_frac_count_calc(
      S1_CLKFBOUT_MULT, S1_CLKFBOUT_PHASE, 50000, S1_CLKFBOUT_FRAC
  );
  ...
  localparam [37:0] S1_CLKOUT0 = mmcm_count_calc(
      S1_CLKOUT0_DIVIDE, S1_CLKOUT0_PHASE, S1_CLKOUT0_DUTY
  );

  localparam [37:0] S1_CLKOUT0_FRAC_CALC = mmcm_frac_count_calc(
      S1_CLKOUT0_DIVIDE, S1_CLKOUT0_PHASE, 50000, S1_CLKOUT0_FRAC
  );

  localparam [37:0] S1_CLKOUT1 = mmcm_count_calc(
      S1_CLKOUT1_DIVIDE, S1_CLKOUT1_PHASE, S1_CLKOUT1_DUTY
  );

  localparam [37:0] S1_CLKOUT2 = mmcm_count_calc(
      S1_CLKOUT2_DIVIDE, S1_CLKOUT2_PHASE, S1_CLKOUT2_DUTY
  );

  localparam [37:0] S1_CLKOUT3 = mmcm_count_calc(
      S1_CLKOUT3_DIVIDE, S1_CLKOUT3_PHASE, S1_CLKOUT3_DUTY
  );

  localparam [37:0] S1_CLKOUT4 = mmcm_count_calc(
      S1_CLKOUT4_DIVIDE, S1_CLKOUT4_PHASE, S1_CLKOUT4_DUTY
  );

  localparam [37:0] S1_CLKOUT5 = mmcm_count_calc(
      S1_CLKOUT5_DIVIDE, S1_CLKOUT5_PHASE, S1_CLKOUT5_DUTY
  );

  localparam [37:0] S1_CLKOUT6 = mmcm_count_calc(
      S1_CLKOUT6_DIVIDE, S1_CLKOUT6_PHASE, S1_CLKOUT6_DUTY
  );
  ...
  localparam [37:0] S2_CLKFBOUT_FRAC_CALC = mmcm_frac_count_calc(
      S2_CLKFBOUT_MULT, S2_CLKFBOUT_PHASE, 50000, S2_CLKFBOUT_FRAC
  );
  ...
  localparam [37:0] S2_CLKOUT0 = mmcm_count_calc(
      S2_CLKOUT0_DIVIDE, S2_CLKOUT0_PHASE, S2_CLKOUT0_DUTY
  );

  localparam [37:0] S2_CLKOUT0_FRAC_CALC = mmcm_frac_count_calc(
      S2_CLKOUT0_DIVIDE, S2_CLKOUT0_PHASE, 50000, S2_CLKOUT0_FRAC
  );

  localparam [37:0] S2_CLKOUT1 = mmcm_count_calc(
      S2_CLKOUT1_DIVIDE, S2_CLKOUT1_PHASE, S2_CLKOUT1_DUTY
  );

  localparam [37:0] S2_CLKOUT2 = mmcm_count_calc(
      S2_CLKOUT2_DIVIDE, S2_CLKOUT2_PHASE, S2_CLKOUT2_DUTY
  );

  localparam [37:0] S2_CLKOUT3 = mmcm_count_calc(
      S2_CLKOUT3_DIVIDE, S2_CLKOUT3_PHASE, S2_CLKOUT3_DUTY
  );

  localparam [37:0] S2_CLKOUT4 = mmcm_count_calc(
      S2_CLKOUT4_DIVIDE, S2_CLKOUT4_PHASE, S2_CLKOUT4_DUTY
  );

  localparam [37:0] S2_CLKOUT5 = mmcm_count_calc(
      S2_CLKOUT5_DIVIDE, S2_CLKOUT5_PHASE, S2_CLKOUT5_DUTY
  );

  localparam [37:0] S2_CLKOUT6 = mmcm_count_calc(
      S2_CLKOUT6_DIVIDE, S2_CLKOUT6_PHASE, S2_CLKOUT6_DUTY
  );
  ...
  localparam [37:0] S3_CLKFBOUT_FRAC_CALC = mmcm_frac_count_calc(
      S3_CLKFBOUT_MULT, S3_CLKFBOUT_PHASE, 50000, S3_CLKFBOUT_FRAC
  );
  ...
  localparam [37:0] S3_CLKOUT0 = mmcm_count_calc(
      S3_CLKOUT0_DIVIDE, S3_CLKOUT0_PHASE, S3_CLKOUT0_DUTY
  );

  localparam [37:0] S3_CLKOUT0_FRAC_CALC = mmcm_frac_count_calc(
      S3_CLKOUT0_DIVIDE, S3_CLKOUT0_PHASE, 50000, S3_CLKOUT0_FRAC
  );

  localparam [37:0] S3_CLKOUT1 = mmcm_count_calc(
      S3_CLKOUT1_DIVIDE, S3_CLKOUT1_PHASE, S3_CLKOUT1_DUTY
  );

  localparam [37:0] S3_CLKOUT2 = mmcm_count_calc(
      S3_CLKOUT2_DIVIDE, S3_CLKOUT2_PHASE, S3_CLKOUT2_DUTY
  );

  localparam [37:0] S3_CLKOUT3 = mmcm_count_calc(
      S3_CLKOUT3_DIVIDE, S3_CLKOUT3_PHASE, S3_CLKOUT3_DUTY
  );

  localparam [37:0] S3_CLKOUT4 = mmcm_count_calc(
      S3_CLKOUT4_DIVIDE, S3_CLKOUT4_PHASE, S3_CLKOUT4_DUTY
  );

  localparam [37:0] S3_CLKOUT5 = mmcm_count_calc(
      S3_CLKOUT5_DIVIDE, S3_CLKOUT5_PHASE, S3_CLKOUT5_DUTY
  );

  localparam [37:0] S3_CLKOUT6 = mmcm_count_calc(
      S3_CLKOUT6_DIVIDE, S3_CLKOUT6_PHASE, S3_CLKOUT6_DUTY
  );
  ...
  initial begin
    ...
    rom[69] = {7'h28, 32'h0000_0000};
    for (ii = 70; ii < 128; ii = ii + 1) begin
      rom[ii] = 0;
    end
  end
  ...
  always @* begin
    ...
    case (current_state)
      ...
      WAIT_SEN: begin
        if (SEN) begin
          // SEN was asserted
          if (SADDR == 2'b00) begin
            // Reconfigure with the first (0) state
            next_rom_addr = 8'h00;
          end else if (SADDR == 2'b01) begin
            // Reconfigure with the second (1) state
            next_rom_addr = STATE_COUNT_CONST;
          end else begin
            // Reconfigure with the second (2) state
            next_rom_addr = STATE_COUNT_CONST * 2;
          end
