# project.tcl - Create PYNQ Draw project for Ultra96V2

# --- Project settings ----------------------------------
set project_dir "./project"
set project_name "pynq_draw"
...
set design_tcl [file join $scripts_dir "pynq_draw.tcl"]
