...
proc create_root_design { parentCell } {
  ...
  # Create instance: patgen_wrap_0, and set properties
  set block_name patgen_wrap
  set block_cell_name patgen_wrap_0
  if { [catch {set patgen_wrap_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $patgen_wrap_0 eq "" } {
  ...
  # Create instance: rst_ps8_0_120M, and set properties
  set rst_ps8_0_120M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_ps8_0_120M ]
...
\
    ...
    CONFIG.PSU__CRL_APB__PL2_REF_CTRL__ACT_FREQMHZ {240.000000} \
...
\
  ...
  [get_bd_pins patgen_wrap_0/RESOL]
  ...
  [get_bd_pins patgen_wrap_0/DCLK]
  connect_bd_net -net patgen_wrap_0_DSP_DAT  [get_bd_pins patgen_wrap_0/DP_DAT] \
  [get_bd_pins zynq_ultra_ps_e_0/dp_live_video_in_pixel1]
  connect_bd_net -net patgen_wrap_0_DSP_DE  [get_bd_pins patgen_wrap_0/DP_DE] \
  [get_bd_pins zynq_ultra_ps_e_0/dp_live_video_in_de]
  connect_bd_net -net patgen_wrap_0_DSP_HSYNC  [get_bd_pins patgen_wrap_0/DP_HSYNC] \
  [get_bd_pins zynq_ultra_ps_e_0/dp_live_video_in_hsync]
  connect_bd_net -net patgen_wrap_0_DSP_VSYNC  [get_bd_pins patgen_wrap_0/DP_VSYNC] \
  [get_bd_pins zynq_ultra_ps_e_0/dp_live_video_in_vsync]
  connect_bd_net -net rst_ps8_0_125M_peripheral_aresetn  [get_bd_pins rst_ps8_0_120M/peripheral_aresetn] \
  ...
  [get_bd_pins patgen_wrap_0/ARESETN]
  ...
  [get_bd_pins rst_ps8_0_120M/slowest_sync_clk] \
  ...
  [get_bd_pins rst_ps8_0_120M/ext_reset_in]
