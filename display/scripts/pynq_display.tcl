...
\
  ...
  connect_bd_intf_net -intf_net display_0_M_AXI [get_bd_intf_pins display_0/M_AXI] [get_bd_intf_pins smartconnect_0/S00_AXI]
  ...
  [get_bd_pins display_0/DCLK] \
  [get_bd_pins zynq_ultra_ps_e_0/dp_video_in_clk]
  connect_bd_net -net display_0_DSP_B  [get_bd_pins display_0/DSP_B] \
  [get_bd_pins cnv2dp_0/DSP_B]
  connect_bd_net -net display_0_DSP_DE  [get_bd_pins display_0/DSP_DE] \
  [get_bd_pins cnv2dp_0/DSP_DE]
  connect_bd_net -net display_0_DSP_FIFO_OVER  [get_bd_pins display_0/DSP_FIFO_OVER] \
  [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net display_0_DSP_FIFO_UNDER  [get_bd_pins display_0/DSP_FIFO_UNDER] \
  [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net display_0_DSP_G  [get_bd_pins display_0/DSP_G] \
  [get_bd_pins cnv2dp_0/DSP_G]
  connect_bd_net -net display_0_DSP_HSYNC_X  [get_bd_pins display_0/DSP_HSYNC_X] \
  [get_bd_pins cnv2dp_0/DSP_HSYNC_X]
  connect_bd_net -net display_0_DSP_IRQ  [get_bd_pins display_0/DSP_IRQ] \
  [get_bd_pins axi_intc_0/intr]
  connect_bd_net -net display_0_DSP_R  [get_bd_pins display_0/DSP_R] \
  [get_bd_pins cnv2dp_0/DSP_R]
  connect_bd_net -net display_0_DSP_VSYNC_X  [get_bd_pins display_0/DSP_VSYNC_X] \
  [get_bd_pins cnv2dp_0/DSP_VSYNC_X]
  connect_bd_net -net display_0_RDATA  [get_bd_pins display_0/RDATA] \
  [get_bd_pins regbus_0/RDATA_DISP]
  connect_bd_net -net regbus_0_BYTEEN  [get_bd_pins regbus_0/BYTEEN] \
  [get_bd_pins display_0/BYTEEN]
  connect_bd_net -net regbus_0_RDADDR  [get_bd_pins regbus_0/RDADDR] \
  [get_bd_pins display_0/RDADDR]
  connect_bd_net -net regbus_0_RDEN  [get_bd_pins regbus_0/RDEN] \
  [get_bd_pins display_0/RDEN]
  connect_bd_net -net regbus_0_WDATA  [get_bd_pins regbus_0/WDATA] \
  [get_bd_pins display_0/WDATA]
  connect_bd_net -net regbus_0_WRADDR  [get_bd_pins regbus_0/WRADDR] \
  [get_bd_pins display_0/WRADDR]
  connect_bd_net -net regbus_0_WREN  [get_bd_pins regbus_0/WREN] \
  [get_bd_pins display_0/WREN]
  ...
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces display_0/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces display_0/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] -force
