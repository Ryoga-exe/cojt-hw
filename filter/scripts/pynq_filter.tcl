...
xilinx.com:user:cnv2dp:1.0\
xilinx.com:user:dclkgen:1.0\
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [list \
    ...
    CONFIG.C_PROCESSOR_CLK_FREQ_MHZ {125} \
  ...
  # Create instance: cnv2dp_0, and set properties
  set cnv2dp_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:cnv2dp:1.0 cnv2dp_0 ]

  # Create instance: dclkgen_0, and set properties
  set dclkgen_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:dclkgen:1.0 dclkgen_0 ]
  ...
  # Create instance: rst_ps8_0_125M, and set properties
  set rst_ps8_0_125M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_ps8_0_125M ]
...
\
  ...
  set filter_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:filter:1.0 filter_0 ]

  # Create interface connections
  connect_bd_intf_net -intf_net display_1_M_AXI [get_bd_intf_pins display_1/M_AXI] [get_bd_intf_pins smartconnect_0/S00_AXI]
  connect_bd_intf_net -intf_net filter_0_M_AXI [get_bd_intf_pins filter_0/M_AXI] [get_bd_intf_pins smartconnect_1/S00_AXI]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M01_AXI [get_bd_intf_pins ps8_0_axi_periph/M01_AXI] [get_bd_intf_pins regbus_0/s00_axi]
  ...
  [get_bd_pins dclkgen_0/RESOL] \
  [get_bd_pins filter_0/RESOL] \
  [get_bd_pins display_1/RESOL]
  ...
  [get_bd_pins dclkgen_0/CLK40]
  connect_bd_net -net cnv2dp_0_DP_DAT  [get_bd_pins cnv2dp_0/DP_DAT] \
  [get_bd_pins zynq_ultra_ps_e_0/dp_live_video_in_pixel1]
  connect_bd_net -net cnv2dp_0_DP_DE  [get_bd_pins cnv2dp_0/DP_DE] \
  [get_bd_pins zynq_ultra_ps_e_0/dp_live_video_in_de]
  connect_bd_net -net cnv2dp_0_DP_HSYNC  [get_bd_pins cnv2dp_0/DP_HSYNC] \
  [get_bd_pins zynq_ultra_ps_e_0/dp_live_video_in_hsync]
  connect_bd_net -net cnv2dp_0_DP_VSYNC  [get_bd_pins cnv2dp_0/DP_VSYNC] \
  [get_bd_pins zynq_ultra_ps_e_0/dp_live_video_in_vsync]
  connect_bd_net -net dclkgen_0_DCLK  [get_bd_pins dclkgen_0/DCLK] \
  [get_bd_pins cnv2dp_0/DCLK] \
  [get_bd_pins zynq_ultra_ps_e_0/dp_video_in_clk] \
  [get_bd_pins display_1/DCLK]
  connect_bd_net -net display_1_DSP_B  [get_bd_pins display_1/DSP_B] \
  [get_bd_pins cnv2dp_0/DSP_B]
  connect_bd_net -net display_1_DSP_DE  [get_bd_pins display_1/DSP_DE] \
  [get_bd_pins cnv2dp_0/DSP_DE]
  connect_bd_net -net display_1_DSP_FIFO_OVER  [get_bd_pins display_1/DSP_FIFO_OVER] \
  [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net display_1_DSP_FIFO_UNDER  [get_bd_pins display_1/DSP_FIFO_UNDER] \
  [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net display_1_DSP_G  [get_bd_pins display_1/DSP_G] \
  [get_bd_pins cnv2dp_0/DSP_G]
  connect_bd_net -net display_1_DSP_HSYNC_X  [get_bd_pins display_1/DSP_HSYNC_X] \
  [get_bd_pins cnv2dp_0/DSP_HSYNC_X]
  connect_bd_net -net display_1_DSP_IRQ  [get_bd_pins display_1/DSP_IRQ] \
  [get_bd_pins xlconcat_1/In0]
  connect_bd_net -net display_1_DSP_R  [get_bd_pins display_1/DSP_R] \
  [get_bd_pins cnv2dp_0/DSP_R]
  connect_bd_net -net display_1_DSP_VSYNC_X  [get_bd_pins display_1/DSP_VSYNC_X] \
  [get_bd_pins cnv2dp_0/DSP_VSYNC_X]
  connect_bd_net -net display_1_RDATA  [get_bd_pins display_1/RDATA] \
  [get_bd_pins regbus_0/RDATA_DISP]
  connect_bd_net -net filter_0_FLT_IRQ  [get_bd_pins filter_0/FLT_IRQ] \
  [get_bd_pins xlconcat_1/In1]
  connect_bd_net -net filter_0_RDATA  [get_bd_pins filter_0/RDATA] \
  [get_bd_pins regbus_0/RDATA_OPT0]
  connect_bd_net -net regbus_0_BYTEEN  [get_bd_pins regbus_0/BYTEEN] \
  [get_bd_pins filter_0/BYTEEN] \
  [get_bd_pins display_1/BYTEEN]
  connect_bd_net -net regbus_0_RDADDR  [get_bd_pins regbus_0/RDADDR] \
  [get_bd_pins filter_0/RDADDR] \
  [get_bd_pins display_1/RDADDR]
  connect_bd_net -net regbus_0_RDEN  [get_bd_pins regbus_0/RDEN] \
  [get_bd_pins filter_0/RDEN] \
  [get_bd_pins display_1/RDEN]
  connect_bd_net -net regbus_0_WDATA  [get_bd_pins regbus_0/WDATA] \
  [get_bd_pins filter_0/WDATA] \
  [get_bd_pins display_1/WDATA]
  connect_bd_net -net regbus_0_WRADDR  [get_bd_pins regbus_0/WRADDR] \
  [get_bd_pins filter_0/WRADDR] \
  [get_bd_pins display_1/WRADDR]
  connect_bd_net -net regbus_0_WREN  [get_bd_pins regbus_0/WREN] \
  [get_bd_pins filter_0/WREN] \
  [get_bd_pins display_1/WREN]
  connect_bd_net -net rst_ps8_0_125M_peripheral_aresetn  [get_bd_pins rst_ps8_0_125M/peripheral_aresetn] \
  [get_bd_pins dclkgen_0/ARESETN] \
  [get_bd_pins regbus_0/s00_axi_aresetn] \
  ...
  [get_bd_pins filter_0/ARESETN] \
  [get_bd_pins display_1/ARESETN]
  ...
  [get_bd_pins regbus_0/RDATA_CAPT] \
  [get_bd_pins regbus_0/RDATA_DRAW] \
  [get_bd_pins regbus_0/RDATA_SOUND] \
  [get_bd_pins regbus_0/RDATA_OPT1] \
  [get_bd_pins regbus_0/RDATA_OPT2] \
  [get_bd_pins regbus_0/RDATA_OPT3]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0  [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] \
  [get_bd_pins regbus_0/s00_axi_aclk] \
  ...
  [get_bd_pins rst_ps8_0_125M/slowest_sync_clk] \
  ...
  [get_bd_pins filter_0/ACLK] \
  [get_bd_pins display_1/ACLK]
  ...
  [get_bd_pins rst_ps8_0_125M/ext_reset_in]
  ...
  assign_bd_address -offset 0x80010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs regbus_0/s00_axi/reg0] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces display_1/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces display_1/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces filter_0/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces filter_0/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_LPS_OCM] -force
